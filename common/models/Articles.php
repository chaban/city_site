...
class Articles extends \Phalcon\Mvc\Model
{
	...
	{
		return Time::nice($this->update_time);
	}
	...
	public function initialize()
	{
		...
		$this->belongsTo('category_id', '\Models\ArticleCategories', 'id', array('alias' => 'Category'));
	}
	...
	public function afterDelete()
	{
		if (!$this->_dir)
		{
			$dir = 'public/uploads/articles/images_id_' . $this->id;
	...
	public function getImages()
	{
		if (!$this->_dir)
		{
			$this->_dir = 'public/uploads/articles/images_id_' . $this->id; //mkdir($this->_dir, 0777, true);
		}
		$itemImageFolder = __dir__ . '/../../' . $this->_dir;
		$result = array();
